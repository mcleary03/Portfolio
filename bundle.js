...
var _displayReducer = __webpack_require__(84);

var _displayReducer2 = _interopRequireDefault(_displayReducer);

var _projectsReducer = __webpack_require__(85);
...
var reducers = (0, _redux.combineReducers)({
  projectsReducer: _projectsReducer2.default,
...
var iframe = function iframe(url) {
  return _react2.default.createElement('iframe', { src: url, frameBorder: '0' });
};
  ...
  _createClass(Popup, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { id: 'popup' + position, className: 'popup' },
        output
      );
    }
  }]);
...
var m=__webpack_require__(2),n=__webpack_require__(11),p=__webpack_require__(4),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(14),B=__webpack_require__(2),C=__webpack_require__(3),ba=__webpack_require__(15),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ia=__webpack_require__(19),D=__webpack_require__(20);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    getInfo: function getInfo(id) {
      return dispatch(setProjects(id));
    }
  };
};
...
var setlaptopDisplay = exports.setlaptopDisplay = function setlaptopDisplay(projectID) {
  return {
    type: 'SET_DISPLAY',
    id: projectID
  };
...
var showProject = exports.showProject = function showProject(projectID) {
  return {
    type: 'SHOW_PROJECT',
    id: projectID
  };
...
var displayReducer = function displayReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { display: _react2.default.createElement(_Popup2.default, null) };
  var action = arguments[1];
...
var newDisplay = function newDisplay(action) {
  switch (action.display) {
    case 'Portfolio':
      return _react2.default.createElement(_Popup2.default, null);
    default:
      return _react2.default.createElement(_Popup2.default, null);
  }
};
...
var projectsReducer = function projectsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { displayedProjects: [], projectInfo: PROJECTS[0] };
  var action = arguments[1];
...
var _Laptop = __webpack_require__(89);
...
var _Btns = __webpack_require__(94);
...
var Display = function (_Component) {
  ...
  function Display() {
    ...
    return _possibleConstructorReturn(this, (Display.__proto__ || Object.getPrototypeOf(Display)).call(this));
  }
  ...
  _createClass(Display, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'main' },
        _react2.default.createElement(_Laptop2.default, null),
        _react2.default.createElement(_Popup2.default, { pos: '1', url: 'https://mcleary03.github.io/dotty/' }),
        _react2.default.createElement(
          _Popup2.default,
          { pos: '2' },
...
var _Laptop = __webpack_require__(90);
...
var Laptop = function (_Component) {
  ...
  function Laptop(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Laptop.__proto__ || Object.getPrototypeOf(Laptop)).call(this, props));
  ...
  _createClass(Laptop, [{
    ...
    value: function componentDidMount() {
      ...
      var closeLid = function closeLid() {
        screen.classList.add('close');
        screen.classList.remove('open');
        keyboard.classList.add('glow');
      };

      var screenClosed = function screenClosed() {
        return screen.classList.contains('close');
      };
      ...
      var lines = ["Hi, I'm a full stack web developer.", "I build user interfaces like this", "This one was made with pure CSS and JavaScript", "and games like this one using D3.js", "I can turn a UI from this", "into this, with useful features like multi-line queries and responsive design"];

      var printLines = function printLines(lines, interval, delay) {
        clearText(text);
        setTimeout(function () {
      ...
      var printString = function printString(string, interval) {
        ...
        setTimeout(function () {
          ...
          string.split('').forEach(function (word, i) {
            setTimeout(function () {
              return p.innerHTML += word;
            }, i * interval);
          });
        }, delay);
      };

      var clearText = function clearText(el) {
        el.innerHTML = '';
      };
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'screen', className: 'close' },
          _react2.default.createElement('div', { className: 'text' })
        ),
        _react2.default.createElement('div', { id: 'keyboard', className: 'glow' })
      );
    }
  }]);
...
if(false) {
	module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./Laptop.scss", function() {
		var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./Laptop.scss");
...
// module
exports.push([module.i, "#laptop {\n  height: 100%;\n  width: auto;\n  cursor: pointer; }\n\n#laptop *,\n#laptop ::before,\n#laptop ::after {\n  box-sizing: border-box; }\n\n#screen {\n  position: relative;\n  margin: 0 auto;\n  height: 100%;\n  width: 99.4%;\n  background-color: #000000;\n  border: 12px solid #111111;\n  border-top: 15px solid #111111;\n  border-bottom: 15px solid #111111;\n  box-shadow: 0 0 0 12px #111111 inset, 0 0 0 2px #000000, 0 0 0 4px #c0c0c0;\n  border-radius: 8px;\n  transform-style: preserve-3d;\n  transform-origin: bottom;\n  transform: rotateX(-15deg);\n  perspective: 100px; }\n\n#screen.close {\n  animation: close 2s forwards cubic-bezier(1, 0, 0.82, 0.63); }\n\n#screen.open {\n  animation: open 2s forwards cubic-bezier(0.21, 1.05, 0.69, 1); }\n\n#screen:before {\n  content: '';\n  position: absolute;\n  top: -1.5%;\n  margin: 0 50%;\n  background-color: #000000;\n  height: 8px;\n  width: 8px;\n  border: 2px solid #222222;\n  border-right: 2px solid #2a2a2a;\n  border-left: 2px solid #2a2a2a;\n  border-radius: 50%;\n  transform: rotateZ(-45deg); }\n\n#screen:after {\n  content: '';\n  position: absolute;\n  top: -18px;\n  bottom: -18px;\n  left: -14px;\n  right: -15px;\n  border-radius: 8px;\n  transform-style: preserve-3d;\n  transform-origin: bottom;\n  transform: rotateY(180deg);\n  background-color: #c0c0c0;\n  perspective-origin: center bottom;\n  perspective: 10px;\n  z-index: -1;\n  backface-visibility: hidden; }\n\n#screen.close:before {\n  animation: hideCamera 2s forwards cubic-bezier(1, -0.15, 0.82, 0.63); }\n\n#screen.close:after {\n  animation: showBack 2s forwards cubic-bezier(1, -0.15, 0.82, 0.63); }\n\n#screen.open:before {\n  animation: showCamera 2s forwards cubic-bezier(1, -0.15, 0.82, 0.63); }\n\n#screen.open:after {\n  animation: hideBack 2s forwards cubic-bezier(1, -0.15, 0.82, 0.63); }\n\n#keyboard {\n  position: relative;\n  top: 2px;\n  width: 100%;\n  height: 2%;\n  background-color: #c0c0c0;\n  margin: 0 auto;\n  border-radius: 2px 2px 0 0; }\n\n#keyboard:before {\n  content: '';\n  position: absolute;\n  background-color: #969696;\n  height: 75%;\n  width: 10%;\n  left: 45%;\n  top: -2px;\n  border-radius: 30%; }\n\n#keyboard:after {\n  content: '';\n  position: absolute;\n  bottom: -70%;\n  height: 75%;\n  width: 100%;\n  border-radius: 0 0 40% 40%;\n  background: linear-gradient(#c0c0c0, #656565);\n  z-index: -1; }\n\n.glow {\n  animation: glow 1.4s 3s infinite ease-in; }\n\n#screen.power .text {\n  animation: power 0.4s 2s forwards ease-out; }\n\n.text {\n  margin: 12px;\n  height: auto;\n  color: #4bf256;\n  font-family: \"Lato\";\n  font-size: 1.1em; }\n\n.text p {\n  margin: 0.5em 0 0.5em 2px; }\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0; }\n  100% {\n    opacity: 1; } }\n\n@keyframes showCamera {\n  1% {\n    opacity: 1; } }\n\n@keyframes hideCamera {\n  90% {\n    opacity: 1; }\n  100% {\n    opacity: 0; } }\n\n@keyframes power {\n  0% {\n    background-color: #000000; }\n  20% {\n    background-color: #070707; }\n  30% {\n    background-color: #070707; }\n  100% {\n    background-color: #000000; } }\n\n@keyframes close {\n  0% {\n    transform: rotateX(-15deg); }\n  100% {\n    transform: rotateX(89deg); } }\n\n@keyframes open {\n  0% {\n    transform: rotateX(89deg); }\n  100% {\n    transform: rotateX(-15deg); } }\n\n@keyframes showBack {\n  99% {\n    backface-visibility: hidden; }\n  100% {\n    backface-visibility: visible; } }\n\n@keyframes hideBack {\n  0% {\n    backface-visibility: visible; }\n  1% {\n    backface-visibility: hidden; } }\n\n@keyframes glow {\n  0% {\n    filter: drop-shadow(0 -4px 10px rgba(33, 196, 193, 0.1)); }\n  50% {\n    filter: drop-shadow(0 -4px 10px rgba(83, 206, 98, 0.9)); }\n  100% {\n    filter: drop-shadow(0 -4px 80px rgba(33, 196, 193, 0.4)); } }\n", ""]);
...
exports.default = function () {
  ...
  var _arr = ['default', 'white', 'red', 'glass', 'green', 'blue', 'yellow', 'orange', 'pink'];
  for (var _i = 0; _i < _arr.length; _i++) {
    var color = _arr[_i];
    btns.push(_react2.default.createElement(
      _Btn2.default,
      { key: color, color: color, caps: true, bold: true, fade: true },
      color
    ));
  }
  ...
  function Btn(props) {
    ...
    _this.handlemouseleave = function (e) {
      return _this.setState(function () {
        return { click: false, hover: false };
      });
    };
    ...
    _this.handlekeydown = function (e) {
      if (_this.isClick(e)) _this.handlemousedown(e);
    };

    _this.handlekeyup = function (e) {
      if (_this.isClick(e)) _this.handlemouseup(e);
    };

    _this.isClick = function (e) {
      return _this.state.focus && (e.keyCode === 32 || e.keyCode === 13);
    };

    _this.handleEvent = function (e) {
      _this['handle' + e.type](e); // handle animations
    ...
    var animate = props.animate || true;
    ...
    _this.clickStyle = _extends({}, _this.hoverStyle, {
  ...
  _createClass(Btn, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.fade) {
        this.fadeTimer = setTimeout(function () {
          _this2.setState({ click: false, focus: false });
        }, 900);
      }
    }
  }, {
    ...
    value: function render() {
      var _state = this.state,
          ...
          fade = _props.fade,
          btnContainerStyle = this.btnContainerStyle,
      ...
      var style = hover || focus ? click ? clickStyle : hoverStyle : defaultStyle;
      var className = fade ? 'fadeIn' : '';
